...
const AllTravel = () => {
  return (
    <div className="roadtrip m-1">
      ...
      <p className="ms-1" id="puppy">Start by reading this article<FaBookOpen className="ms-1"/></p>
      ...
      <p className="ms-1" id="puppy">Then search our database for everything from dog friendly hotels to dog parks to veterinarians to rest stops.</p>
    </div>
  );
};
