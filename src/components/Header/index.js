...
function Header() {
  return (
    <header className="col-12 d-inline-flex pb-3">
      <div>
        <Link to="/">
          <h1 id="navheader" className="d-inline-flex w-100 justify-content-center ms-4">
            Woof's Up!
          </h1>
        </Link>
        ...
        <div id="nav" className="ms-5 mt-1">
          <nav className="text-center d-inline-flex flex-row">
            <>
              <Link className="navlinks me-3" to="/">
                Home
              </Link>
              <FaPaw className="m-2" />
              <Link className="navlinks me-3" to="/travel">
                Travel
              </Link>
              <FaPaw className="m-2" />
              <Link className="navlinks me-3" to="/AllTravel">
                Plains, Trains, and Automobiles
              </Link>
              <FaPaw className="m-2" />
              <Link className="navlinks" to="/Boarding">
                Boarding
              </Link>
            </>
          </nav>
